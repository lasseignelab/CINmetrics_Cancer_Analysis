...
load(all.gex.list)
all.cinmetrics.df <- read.csv("/data/project/lasseigne_lab/SashaThalluri/CINmetrics_Cancer_Analysis/data/processed/all_cinmetrics_df.csv")
...
brca.laml.subtypes.cinmetrics.pi.df  <- full_join(brca.laml.log.cinmetrics.pi.df, breast.subtypes, by = c("patient_id" = "Complete TCGA ID")) %>%
  rename("breast_subtype" = "PAM50 mRNA") %>% drop_na(project) 
