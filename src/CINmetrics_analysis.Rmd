...
## CINmetrics with CIN metrics Package
...
# Base Segments Plot
base_segments_stripchart <- ggstripchart(all.cinmetrics.df,
...
break_points_stripchart <- ggstripchart(all.cinmetrics.df,
...
tai_stripchart <- ggstripchart(all.cinmetrics.df,
                                      x = "project", y = "tai", 
                                      fill = "sample_type", 
                                      color = "sample_type", 
                                      palette = "simpsons", 
...
fga_stripchart <- ggstripchart(all.cinmetrics.df,
                                      x = "project", y = "fga", 
                                      fill = "sample_type", 
                                      color = "sample_type", 
                                      palette = "simpsons", 
...
cna_stripchart <- ggstripchart(all.cinmetrics.df,
                                      x = "project", y = "cna", 
                                      fill = "sample_type", 
                                      color = "sample_type", 
                                      palette = "simpsons", 
...
modified_tai_stripchart <- ggstripchart(all.cinmetrics.df,
                                      ...
                                      add = "mean_sd", add.params = list(size = .05, alpha = 1, group = "sample_type", color = "black")) 
# CINmetrics Plot
cinmetrics_stripchart <- ggarrange(base_segments_stripchart, 
                                   break_points_stripchart, 
                                   tai_stripchart, 
                                   fga_stripchart, 
                                   cna_stripchart,
                                   modified_tai_stripchart, 
                                   ncol = 3, nrow = 2, 
                                   legend = "right", 
                                   common.legend = TRUE)

return(cinmetrics_stripchart)
}

cinmetrics_stripchart <- get_cinmetrics_stripchart(all.cinmetrics.df)
cinmetrics_stripchart
```
