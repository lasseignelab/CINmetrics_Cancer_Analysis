...
```{r}
## This function will take the dataframe with all of the CINmetrics values and will plot a stripchart.

get_cinmetrics_stripchart <- function(all.cinmetrics.df){
# Grouping normal and tumor samples
...
# Plotting stripchart
cinmetrics <- c("tai", "modified_tai", "cna", "base_segments", "break_points", "fga")
cinmetrics_stripchart <- ggstripchart(all.cinmetrics.df,
                                      x = "project", y = cinmetrics, 
                                      fill = "sample_type", 
                                      color = "sample_type", 
                                      palette = "simpsons", 
                                      size = .05, 
                                      xlab = "Cancer", ylab = "log10(CINmetrics)", 
                                      yscale = "log10",
                                      format.scale = TRUE,
