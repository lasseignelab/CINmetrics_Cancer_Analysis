...
all.cinmetrics.df <- inner_join(cinmetrics.cancer, all.cancer.df[,c(7,10)], by = c("sample_id" = "Sample")) %>% unique(.) %>% select("sample_id", "patient_id", "project", "tai", "modified_tai", "cna", "base_segments", "break_points", "fga")
