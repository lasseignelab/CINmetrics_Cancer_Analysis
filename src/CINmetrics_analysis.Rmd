...
```{r}
## This function will take the dataframe with all of the CINmetrics values, subset the tumor samples, and will plot a heatmap for all of the CINmetrics across all 33 cancers.
